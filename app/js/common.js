$(function () {
  ...
  var slider4 = $(".releab__slider").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    infinite: false,
    dots: false,
  ...
  /* var input = document.querySelector(".phone-contact");
  intlTelInput(input, {
    initialCountry: "ru",
    separateDialCode: true,
  }); */

  var sliderRdr = $(".rdr__slider").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    infinite: false,
    dots: true,
